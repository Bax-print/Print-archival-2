...
function print_archival_render_intake_form() {
	...
	<form id="pa-intake-form" class="pa-intake-form" action="" method="POST" enctype="multipart/form-data">
		<input type="hidden" name="pa_intake_action" value="submit">
        <input type="hidden" name="pa_ajax_submit" value="1">
...
$email_body .= '<p><strong>File Status:</strong><br>' . $file_status . '</p>';
